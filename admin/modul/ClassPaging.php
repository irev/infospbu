...
class CnnNav {
    ...
    function CnnNav ($maxRows, $table, $strFieldSelect = "*", $tableId = "", $numShow = "9", $interval = "5", $intervalShow = "3", $prev = "&lt;&lt;&nbsp;", $next = "&nbsp;&gt;&gt;", $separator = " ", $css = "", $first = "&laquo;&laquo;", $last = "&raquo;&raquo;", $strOffset = "offset") {
