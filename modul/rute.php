...
function dekat(){
//$( "#lokasiterdekat" ).load( "modul/test_get_json.php" );
$( "#lokasiterdekat" ).load( "modul/test_get_json.php", function( response, status, xhr ) {
  if ( status == "error" ) {
  ...
  <div id="panel">
    ...
    <!--select class="input" name="ends" id="ends" >
		<?php
      ...
      <span><!--input id="btn" type="button" class="btn btn-flat" value="Search" onclick="calcRoute()"/--><a type="submit" name="dekat" class="btn btn-flat" onclick="dekat()" ><span id='loading' style='display:none'> Penelusuran </span><i class="fa fa-info"></i>SPBU Terdekat</a>
      <span id='loading2' style='display:none'> Sedang Mencari SPBU terdekat ..</span>
      </span>
  <div id="lokasiterdekat"></div>      
